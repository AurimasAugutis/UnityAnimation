Shader "Custom/HDRP/Planet"
{
    Properties
    {
		...
		_SkyblendA("Sky blend (A)", Color) = (0.55417,0.6973749,0.755,0)
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			UNITY_INSTANCING_BUFFER_START(ExoPlanetsHDRPPlanet)
				UNITY_DEFINE_INSTANCED_PROP(float4, _PolarMask_ST)
				UNITY_DEFINE_INSTANCED_PROP(float3, _LightSource)
			UNITY_INSTANCING_BUFFER_END(ExoPlanetsHDRPPlanet)
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float4 _PolarMask_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(ExoPlanetsHDRPPlanet,_PolarMask_ST);
				...
				float3 _LightSource_Instance = UNITY_ACCESS_INSTANCED_PROP(ExoPlanetsHDRPPlanet,_LightSource);
...
/*ASEBEGIN
Version=17700
-1680;203;1680;989;221.939;3547.648;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;17;-1171.549,-3410.393;Inherit;False;2229.833;494.3665;Custom Masks;7;215;120;66;37;32;31;419;;1,0,0,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;95;2069.631,-3188.124;Inherit;False;841.3491;438.9991;Comment;3;409;0;236;Second shader pass output;1,0,0,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;31;254.8311,-3360.503;Inherit;False;623.6577;353.3621;+ Specular with custom mask;3;227;162;421;;1,0,0.02568626,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;236;2121.389,-2923.831;Inherit;False;211;SecondPassInput;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;409;2090.349,-3132.059;Inherit;False;Constant;_Color0;Color 0;38;0;Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;419;877.267,-2968.588;Inherit;False;Property;_IlluminationBoost;Illumination Boost;36;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;421;815.4567,-3173.452;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;418;1104.415,-3155.362;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;420;375.4567,-2903.452;Inherit;False;Property;_SkyblendA;Sky blend (A);37;0;Create;True;0;0;False;0;0.55417,0.6973749,0.755,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;2656.286,-3070.646;Float;False;True;-1;2;PlanetEditor;0;15;Exo-Planets/HDRP/Planet;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;8;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;0;True;-21;0;True;-22;1;0;True;-23;0;True;-24;False;False;True;0;False;-26;False;True;True;0;True;-6;255;False;-1;255;True;-7;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;0;True;-25;True;0;True;-31;False;True;1;LightMode=ForwardOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;18;Surface Type;0;  Rendering Pass ;0;  Rendering Pass;1;  Blending Mode;0;  Receive Fog;1;  Distortion;0;    Distortion Mode;0;    Distortion Depth Test;1;  ZWrite;1;  Cull Mode;0;  Z Test;4;Double-Sided;0;Alpha Clipping;0;Add Precomputed Velocity;0;Cast Shadows;0;Receive Shadows;0;GPU Instancing;0;Vertex Position,InvertActionOnDeselection;1;0;6;True;False;True;True;True;True;False;;0
...
ASEEND*/
//CHKSM=FF1EAEA692869DAC2869E9B6459C4D975B1D0AD5