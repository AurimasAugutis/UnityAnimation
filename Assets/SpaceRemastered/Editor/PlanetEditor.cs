...
public class PlanetEditor : ShaderGUI
{
  ...
  //  private bool m_IlluminationShow = true;
    ...
    public Texture2D Clouds_Light = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/SpaceRemastered/_Resources/Textures/Clouds_Light.tga", typeof(Texture2D));
    public Texture2D Clouds_Average = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/SpaceRemastered/_Resources/Textures/Clouds_Average.tga", typeof(Texture2D));
	public Texture2D Clouds_Heavy = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/SpaceRemastered/_Resources/Textures/Clouds_Heavy.tga", typeof(Texture2D));
	
    public Texture2D Clouds_Light_N = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/SpaceRemastered/_Resources/Textures/Clouds_Light_N.tga", typeof(Texture2D));
    public Texture2D Clouds_Average_N = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/SpaceRemastered/_Resources/Textures/Clouds_Average_N.tga", typeof(Texture2D));
    public Texture2D Clouds_Heavy_N = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/SpaceRemastered/_Resources/Textures/Clouds_Heavy_N.tga", typeof(Texture2D));
            ...
            using (new EditorGUI.DisabledGroupScope(EnableClouds.floatValue == 0))
            {
                ...
                switch (CloudsText)
                {
                    case OPTIONS2.LightClouds:
                        materialEditor.SetTexture("_CloudsTexture", Clouds_Light);
                        materialEditor.SetTexture("_CloudsNormals", Clouds_Light_N);
                        CloudsText = OPTIONS2.LightClouds;
                        break;
                    case OPTIONS2.AverageClouds:
                        materialEditor.SetTexture("_CloudsTexture", Clouds_Average);
                        materialEditor.SetTexture("_CloudsNormals", Clouds_Average_N);
                        break;
                    case OPTIONS2.HeavyClouds:
                        materialEditor.SetTexture("_CloudsTexture", Clouds_Heavy);
                        materialEditor.SetTexture("_CloudsNormals", Clouds_Heavy_N);
                        break;
                ...
                materialEditor.SetFloat("_EnumFloat", (float)CloudsText);
